...
function proceed() {
    ...
    //else if (rightWrongStatus == "correct")
    //    setTimeout(function () { UDUTU_API.goScreen(UDUTU_API.getNextScreen().id) }, 1000);
    else if (rightWrongStatus.length > 0)
...
UDUTU_API.gblNextButton.btnEnabled(true);
		...
		if (rightWrongStatus != null && feedBack[rightWrongStatus] == "") {
			proceed();
		}
	};
